class NoticiaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @noticium.save
        format.html { redirect_to @noticium, notice: 'a noticia fue creada con éxito.' }
  ...
  def update
    respond_to do |format|
      if @noticium.update(noticium_params)
        format.html { redirect_to @noticium, notice: 'La noticia fue actualizada.' }
  ...
  def destroy
    @noticium.destroy
    respond_to do |format|
      format.html { redirect_to noticia_url, notice: 'La noticia fue eliminada' }
